...
export function registerBatchTools(server: ServerType) {
  ...
  registerRawBatchTool(server, "brc_batch_sales_credit_notes", "Processes a batch of sales credit notes.", "/v1/salesCreditNotes");
  registerRawBatchTool(server, "brc_batch_sales_entries", "Processes a batch of sales entries.", "/v1/salesEntries");
  registerRawBatchTool(server, "brc_batch_sales_invoices", "Processes a batch of sales invoices.", "/v1/salesInvoices");

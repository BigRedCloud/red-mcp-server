...
export const FIND_HELP_RESOURCES_TOOL_DESCRIPTION = [
  ...
  "Use when the customer asks a support question or how-to question about Big Red Cloud, after clarifying tutorial versus Red action when needed.",
  ...
  "Include the Big Red Cloud support contact link only when supportFallbackRecommended is true or the answer is incomplete, company-specific, or uncertain — not on every successful complete answer.",
  "In tutorial mode, never claim company data was changed.",
].join(" ");
...
export const GET_HELP_RESOURCE_DETAILS_TOOL_DESCRIPTION = [
  ...
  "Freshdesk resources return cleaned article text, the canonical Freshdesk publicUrl when available, preferred instructionBlocks, ready-to-use customerFacingScreenshotMarkdown / customerFacingInstructionMarkdown, screenshotUrls for backward compatibility, Sources fields, and optional MCP image content.",
  ...
  "Include supportFallback Markdown only when supportFallbackRecommended is true.",

...
export function isStrictRedPublicBaseUrlMode(): boolean {
...
export function validateCustomerFacingPublicBaseUrl(
  baseUrl: string,
 ...
 */
export function getRedPublicBaseUrl(): string {
...
export function getCustomerFacingScreenshotBaseUrl(): string | null {

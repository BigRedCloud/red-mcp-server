...
import { buildTelemetryCustomDimensions, getRedTelemetryContext, looksSensitiveTelemetryValue, } from "./identity.js";
let lastFailureForTests;
...
export function buildBrcFailureTelemetryDimensions(args) {
 ...
 */
export function recordBrcDownstreamFailureTelemetry(args) {
    try {
        ...
        span.end();
        console.info("Red BRC request failed:", JSON.stringify({
...
export function __resetBrcFailureTelemetryForTests() {

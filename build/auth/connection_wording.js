 ...
 */
export const DO_NOT_REUSE_OLD_CONNECTION_LINK = "Do not reuse an old, used, expired, or previously shared secure Red connection link.";
export const DO_NOT_PASTE_API_KEY_IN_CHAT = "Do not ask the user to paste an API key into chat.";
...
export const FRESH_CONNECTION_LINK_CLAIM_GUIDANCE = "Start a fresh company connection to generate a new secure Red connection link — do not reuse an old link.";

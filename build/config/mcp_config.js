...
export const API_KEY_REFUSAL_MESSAGE = "BRC company API keys cannot be shown, retrieved, repeated, validated, or reconstructed. They are stored only in this MCP session memory for about 2 hours and are never returned by tools. If you need to connect again, use the secure Red connection page. Do not paste API keys into chat. ";

...
export const RED_HELP_ROUTING_OVERRIDE = "RED-HELP ROUTING OVERRIDE: If the user's message begins with red-help or /red-help, immediately call brc_red_help with the remaining text. Do not search for or call transactional accounting tools first. RED-HELP always means manual guidance and resources, not permission to perform the action.";

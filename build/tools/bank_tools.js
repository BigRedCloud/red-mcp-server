...
export function registerBankTools(server) {
    ...
    server.tool("brc_create_bank_account", [
        ...
        nominalAcCode: z
            .string()
            .optional()
            .describe("Existing linked nominal account code. This must already exist in Big Red Cloud and will be sent to the API as account.acCode."),
        lastChq: z
            .string()
            .optional()
        ...
        const missingRequiredFields = [
            ...
            ["linked nominal account code", payload.account?.acCode],
        ...
        if (!confirmCreate) {
            return textResponse([
                ...
                `Linked nominal account code: ${String(payload.account.acCode)}`,

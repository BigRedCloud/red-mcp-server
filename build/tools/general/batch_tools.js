...
import { SALES_DOCUMENT_PRODUCT_ID_DESCRIPTION } from "./payloads_tools.js";
export function registerBatchTools(server) {
    ...
    registerRawBatchTool(server, "brc_batch_sales_invoices", `Processes a batch of sales invoices. ${SALES_DOCUMENT_PRODUCT_ID_DESCRIPTION}`, "/v1/salesInvoices");

...
import { formatCompanyProcessingSettings, getCompanyProcessingSettings, getTransactionSafetyWarnings, } from "../../guards/company_processing_settings.js";
import { formatCompanyReferenceSettings, getCompanyReferenceSettings, } from "../../guards/company_reference_settings.js";
import { diagnoseCompanyProcessingSettings } from "../../dev_company_processing_settings_diagnostic.js";
export function registerCompanyProcessingSettingsTools(server) {
    server.tool("brc_get_company_processing_settings", [
        ...
        includeRaw: z
            .boolean()
            .default(false)
            .describe("If true, includes the raw BRC settings record for operator review. Customer-facing responses should normally leave this false."),
    ...
    server.tool("brc_get_company_reference_settings", [
        ...
        includeRaw: z
            .boolean()
            .default(false)
            .describe("If true, includes the raw BRC company setup record for operator review. Customer-facing responses should normally leave this false."),
    }, async ({ companyName, includeRaw }) => {
    ...
    server.tool("brc_check_transaction_settings", [
        ...
        workflow: z
            ...
            .describe("The workflow to check against the company processing settings."),
    ...
    server.tool("brc_dev_diagnose_company_processing_settings", [
        ...
        companyName: companyNameSchema,
    }, async ({ companyName }) => jsonResponse(await diagnoseCompanyProcessingSettings(companyName)));
}

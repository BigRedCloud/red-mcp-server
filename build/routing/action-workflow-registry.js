...
function detectPrimaryAction(text) {
    const regex = /\b(add|create|set\s+up|setup|new|raise|prepare|record|post|update|change|edit|amend|modify|delete|remove|erase|batch|bulk|import|email|send|mail)\b/i;

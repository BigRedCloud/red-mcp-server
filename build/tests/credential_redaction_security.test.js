...
import { decodeStoredApiKey, encodeStoredApiKey, } from "../auth/credential_secret.js";
import { renderConnectPage, renderConnectionFailedPage, renderSuccessPage, } from "../auth/connection_page.js";
...
test("error pages escape user supplied HTML to prevent reflected XSS", () => {
    const html = renderConnectionFailedPage(`<script>alert("xss")</script><img src=x onerror=alert(1)>`);

...
const EXAMPLE_WINDOWS_SUPPORT_CSV = "C:\\Users\\example\\Documents\\Red Edu\\webinar_video_routing_index.csv";
const EXAMPLE_WINDOWS_ENRICHED_CSV = "C:\\Users\\example\\Documents\\Red Edu\\dev_only_video_routing_index_updated.csv";
const EXAMPLE_WINDOWS_SUPPORT_CSV_FORWARD = "C:/Users/example/Documents/Red Edu/webinar_video_routing_index.csv";
...
test("resolveBrcEduCsvPath keeps Windows drive-letter paths unchanged", () => {
    assert.equal(resolveBrcEduCsvPath(EXAMPLE_WINDOWS_SUPPORT_CSV, DEFAULT_BRC_EDU_SUPPORT_CSV_PATH, BASE_DIR), EXAMPLE_WINDOWS_SUPPORT_CSV);
    assert.equal(resolveBrcEduCsvPath(EXAMPLE_WINDOWS_SUPPORT_CSV_FORWARD, DEFAULT_BRC_EDU_SUPPORT_CSV_PATH, BASE_DIR), EXAMPLE_WINDOWS_SUPPORT_CSV_FORWARD);
});

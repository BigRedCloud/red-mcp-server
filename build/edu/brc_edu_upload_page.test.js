...
import { CONTENT_OVERVIEW_REQUIRED_ELEMENT_IDS, findAdminPageElementIdsBeforeScript, getAdminPageScriptReferencedElementIds, parseBrcEduAdminView, renderBrcEduUploadPage, } from "./brc_edu_upload_page.js";
...
test("overview view includes every required overview element id", () => {
    ...
    assert.deepEqual(new Set(referencedIds), new Set([...CONTENT_OVERVIEW_REQUIRED_ELEMENT_IDS]));

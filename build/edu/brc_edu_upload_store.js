...
export function resolveUploadExtension(filename) {
...
export function contentTypeForUploadExtension(extension) {
    if (extension === "csv") {
        return "text/csv";
    }
...
export function buildBrcEduBlobNames(extension, now = new Date()) {
...
export function createAzureBlobUploader(connectionString, containerName) {
...
export function createConfiguredBrcEduBlobUploader() {
...
export async function handleBrcEduResourceUpload(file, uploader = createConfiguredBrcEduBlobUploader()) {

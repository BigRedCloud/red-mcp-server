...
export const YOUTUBE_VISIBILITY_API_PATH_PREFIX = "/internal/brc-edu/youtube/videos/";
...
export function youtubeVideosApiUrl(auth) {
    return withOptionalSecretQuery(YOUTUBE_VIDEOS_API_PATH, auth);
}
export function youtubeSyncApiUrl(auth) {
...
export function renderYouTubeAdminSectionHtml(auth) {
...
export function youtubeAdminSectionCss() {
    return `

...
export function authorizeYouTubeServiceSyncSecret(providedSecret) {
...
export async function handleYouTubeAdminListVideos() {
...
export async function handleYouTubeAdminManualSync() {
...
export async function handleYouTubeServiceSync(source = "timer") {

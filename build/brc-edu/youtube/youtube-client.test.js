...
import { buildRawCatalogVideos, classifyYouTubeVideoCategory, fetchVideoSnippetsByIds, listAllPlaylistVideoIds, } from "./youtube-client.js";
...
test("YouTube playlist pagination retrieves all pages", async () => {
    ...
    assert.deepEqual(items.map((item) => item.videoId), ["v1", "v2"]);

...
export function getFreshdeskKbStorageConnectionString() {
    const kbConnection = process.env.BRC_EDU_KB_STORAGE_CONNECTION?.trim() ??
...
export function getFreshdeskKbImageContainerName() {
    return (process.env.BRC_EDU_KB_IMAGE_CONTAINER?.trim() ||

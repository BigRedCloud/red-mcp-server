...
export const FRESHDESK_ARTICLES_API_PATH = "/internal/brc-edu/freshdesk/articles";
export const FRESHDESK_SYNC_API_PATH = "/internal/brc-edu/freshdesk/sync";
export const FRESHDESK_VISIBILITY_API_PATH_PREFIX = "/internal/brc-edu/freshdesk/articles/";
...
export function freshdeskArticlesApiUrl(auth) {
    return withOptionalSecretQuery(FRESHDESK_ARTICLES_API_PATH, auth);
}
export function freshdeskSyncApiUrl(auth) {
...
export function renderFreshdeskAdminSectionHtml(auth) {
...
(() => {
  ...
  const visibilityBase = ${JSON.stringify(FRESHDESK_VISIBILITY_API_PATH_PREFIX)};
...
export function freshdeskAdminSectionCss() {
    return `

...
test("extractFreshdeskImages extracts valid HTTPS img src values", () => {
  ...
  `;
    ...
    assert.equal(images[0]?.sourceUrl, "https://cdn.freshdesk.com/helpdesk/attachments/a.png");
    assert.equal(images[1]?.sourceUrl, "https://s3.amazonaws.com/freshdesk-assets/b.jpg");
});

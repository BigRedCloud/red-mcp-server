...
import { buildFreshdeskInstructionBlocks, enrichScreenshotUrlCaptions, } from "./instruction-blocks.js";
...
test("instructionBlocks alternate correctly between text and screenshots", () => {
    ...
    const blocks = buildFreshdeskInstructionBlocks(parsed.contentBlocks, screenshotUrls);
...
test("caption combines heading with fill instruction for A/C Code", () => {
    ...
    assert.equal(caption, "Add Customer screen — enter the required A/C Code");
});

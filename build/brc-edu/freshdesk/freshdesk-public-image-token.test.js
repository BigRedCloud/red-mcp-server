...
import { createFreshdeskPublicImageToken, FRESHDESK_PUBLIC_IMAGE_TOKEN_TTL_SECONDS, verifyFreshdeskPublicImageToken, } from "./freshdesk-public-image-token.js";
...
test("verifyFreshdeskPublicImageToken rejects expired token", () => {
    ...
    assert.equal(verifyFreshdeskPublicImageToken(token, {

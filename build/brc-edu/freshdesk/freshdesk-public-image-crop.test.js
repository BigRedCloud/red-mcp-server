...
import { analyzeFreshdeskPublicImageCropBounds, detectFreshdeskPublicImageCropBounds, normalizeFreshdeskPublicImageBuffer, } from "./freshdesk-public-image-crop.js";
...
test("detectFreshdeskPublicImageCropBounds returns null when content fills the frame", () => {
    ...
    const bounds = detectFreshdeskPublicImageCropBounds(width, height, mask, 320, 240);
